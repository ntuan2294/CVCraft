...
export const CV_TEMPLATES: CVTemplate[] = [
  {
    ...
    thumbnail: '/template-images/temp1-v2.jpg?v=20260524',
    fields: ['photo', 'name', 'job_title', 'profile', 'work_experience', 'education', 'contact', 'language', 'skills', 'certificate', 'references'],
  },
  {
    id: '2',
    name: 'Template 2',
    ...
    supportsPhotoUpload: true,
    thumbnail: '/template-images/temp2.jpg?v=20260524',
    fields: ['photo', 'name', 'job_title', 'about_me', 'work_experience', 'education', 'contact', 'skills', 'certificate'],
  },
  {
    id: '3',
    name: 'Template 3',
    ...
    thumbnail: '/template-images/temp3.jpg?v=20260524',
    fields: ['name', 'job_title', 'profile', 'work_experience', 'education', 'contact', 'language', 'skills'],
  },
  {
    id: '4',
    name: 'Template 4',
    ...
    supportsPhotoUpload: false,
    thumbnail: '/template-images/temp4.jpg?v=20260524',
    fields: ['name', 'job_title', 'summary', 'work_experience', 'education', 'contact', 'skills'],
  },
  {
    id: '5',
    name: 'Template 5',
    ...
    summaryLabel: 'About me',
    supportsPhotoUpload: true,
    thumbnail: '/template-images/temp5-v2.jpg?v=20260524',
    fields: ['photo', 'name', 'job_title', 'about_me', 'work_experience', 'education', 'contact', 'language', 'skills', 'certificate', 'references'],
  },
  {
    id: '6',
    name: 'Template 6',
    ...
    summaryLabel: 'About me',
    supportsPhotoUpload: true,
    thumbnail: '/template-images/temp6.jpg?v=20260524',
    fields: ['photo', 'name', 'job_title', 'about_me', 'work_experience', 'education', 'contact', 'language', 'skills', 'certificate', 'references'],
  },
]

export const TEMPLATE_PATH_BY_ID: Record<string, string> = {
  '1': 'template cv/1.html',
  '2': 'template cv/2.html',
  '3': 'template cv/3.html',
  '4': 'template cv/4.html',
  '5': 'template cv/5.html',
