...
"""
from state import CVAgentState, QualityScore
...
1. ATS_SCORE (compatibility với hệ thống Applicant Tracking System):
   ...
   - 9-10: Excellent. 7-8: Good. 5-6: Average. <5: Poor.
...
- Ví dụ: "[Experience] Bullet thứ 2 ở job ABC chưa lượng hóa -> thêm số liệu về scale hoặc impact"

NEEDS_REVISION = True nếu overall_score < 7.0, ngược lại False.

Chấm khắt khe. Đừng cho điểm cao chỉ vì CV trông ổn - phải xuất sắc mới đáng 9-10."""
...
"""
    ...
    try:
        ...
        # Override needs_revision dựa vào max_revisions
        if state.revision_count >= state.max_revisions:
            score.needs_revision = False  # Force stop
