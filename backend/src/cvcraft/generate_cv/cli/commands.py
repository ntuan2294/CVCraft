...
Usage:
    python -m cvcraft.generate_cv.cli.commands generate
    python -m cvcraft.generate_cv.cli.commands build-index
    python -m cvcraft.generate_cv.cli.commands rag-stats
...
def build_hf_index(
    ...
    if dry_run:
        from cvcraft.generate_cv.rag.indexing.indexer import index_hf_samples
