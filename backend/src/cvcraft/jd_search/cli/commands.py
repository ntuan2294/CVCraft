...
Usage:
    python -m cvcraft.jd_search.cli.commands build-jd-index
    python -m cvcraft.jd_search.cli.commands build-seed-index
    python -m cvcraft.jd_search.cli.commands jd-search "backend python"
    python -m cvcraft.jd_search.cli.commands jd-stats
