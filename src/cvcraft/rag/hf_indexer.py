...
Usage:
    python -m cvcraft.rag.hf_indexer                      # default: 300 mẫu top-quality
    python -m cvcraft.rag.hf_indexer --max-samples 500
    python -m cvcraft.rag.hf_indexer --target 100
    python -m cvcraft.rag.hf_indexer --reset
    python -m cvcraft.rag.hf_indexer --min-score 6.0
    python -m cvcraft.rag.hf_indexer --no-seed
"""
import argparse
import sys
from cvcraft.rag.vector_store import CVVectorStore
from cvcraft.rag.hf_loader import load_huggingface_resumes, parse_all_resumes
from cvcraft.rag.quality_filter import filter_quality
