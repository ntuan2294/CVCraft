...
class LLMFactory:
    ...
    - 'cheap': cho task đơn giản (JD parsing, ATS check) -> gpt-4o-mini
    - 'strong': cho task phức tạp (writing experience, scoring) -> gpt-4o

    Có thể đổi sang model khác (gpt-4-turbo, o1-mini, ...) tùy nhu cầu và ngân sách.
    """
...
def call_with_structured_output(
    ...
    OpenAI hỗ trợ structured output natively (JSON mode + function calling).
    """
