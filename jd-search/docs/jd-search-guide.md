...
Tính năng tìm kiếm JD theo ngữ nghĩa — người dùng nhập keyword hoặc mô tả mong muốn, hệ thống tìm Top-K JD liên quan và dùng LLM để chuẩn hóa nội dung JD thành các section dễ đọc.
...
ChromaDB tìm Top-K JD tương đồng nhất
        │
        ▼
gpt-4o-mini chuẩn hóa section JD
        │
        ▼
Trả về: Top JDs đã format mô tả / yêu cầu / phúc lợi
```
...
| File | Vai trò |
|---|---|
| [../src/jd_search/rag/loaders/hf_jd_loader.py](../src/jd_search/rag/loaders/hf_jd_loader.py) | Load + parse dataset HuggingFace |
| [../src/jd_search/rag/indexing/jd_indexer.py](../src/jd_search/rag/indexing/jd_indexer.py) | Index JDs vào ChromaDB |
| [../src/jd_search/rag/vector_store.py](../src/jd_search/rag/vector_store.py) | ChromaDB wrapper (collection `job_descriptions`) |
| [../src/jd_search/services/jd_search_service.py](../src/jd_search/services/jd_search_service.py) | Service layer orchestration |
| [../src/jd_search/api/v1/jd.py](../src/jd_search/api/v1/jd.py) | FastAPI endpoints |
| [../src/jd_search/core/models.py](../src/jd_search/core/models.py) | Pydantic models |
